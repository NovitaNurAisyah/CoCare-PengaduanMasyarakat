...
<aside class="z-20 hidden w-64 overflow-y-auto dark:bg-gray-800 md:block flex-shrink-0">
  <div class="py-4 text-gray-500 dark:text-gray-400">
    <img src="<?php echo e(asset('img/care2.png')); ?>" alt="" height="200" width="200"
    ...
    <ul class="mt-6">
      <li class="relative px-6 py-3">
        <span
          class="<?php echo e((request()->routeIs('dashboard')) ? 'absolute inset-y-0 left-0 w-1 bg-blue rounded-tr-lg rounded-br-lg' : ''); ?> "
    ...
    <ul>
      <li class="relative px-6 py-3">
        <span
          class="<?php echo e((request()->is('admin/masyarakat')) ? 'absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg' : ''); ?> "
          aria-hidden="true"></span>
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
...
</aside><?php /**PATH C:\laragon\www\project\CoCare\resources\views/includes/admin/sidebar.blade.php ENDPATH**/ ?>