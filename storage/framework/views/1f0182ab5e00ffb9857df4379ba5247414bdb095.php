      ...
      <div class="w-full overflow-x-auto">
        ...
        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800 ">
          <div class="relative hidden mr-3  md:block ">
            ...
            <img class=" h-32 w-37 " src="<?php echo e(Storage::url($item->image)); ?>" alt="" loading="lazy" />
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.masyarakat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\project\CoCare\resources\views/pages/masyarakat/show.blade.php ENDPATH**/ ?>